    ...
    <div class="container">
        ...
        <div class="">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('teacher.question.update', $question->id) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="question" class="form-control @error('question') is-invalid @enderror" id="question" rows="4"
                                autocomplete="question" autofocus>{{ $question->question }}</textarea>
                            @error('question')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="option_a"
                                ...
                                value="{{ $question->option_a }}" autocomplete="option_a" autofocus>
                            @error('option_a')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="option_b"
                                ...
                                value="{{ $question->option_b }}" autocomplete="option_b" autofocus>
                            @error('option_b')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="option_c"
                                ...
                                value="{{ $question->option_c }}" autocomplete="option_c" autofocus>
                            @error('option_c')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="option_d"
                                ...
                                value="{{ $question->option_d }}" autocomplete="option_d" autofocus>
                            @error('option_d')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="correct_option" value="option_a"
                                    id="option_radio_a" @checked($question->correct_option == 'option_a')>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="correct_option" value="option_b"
                                    id="option_radio_b" @checked($question->correct_option == 'option_b')>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="correct_option" value="option_c"
                                    id="option_radio_c" @checked($question->correct_option == 'option_c')>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="correct_option" value="option_d"
                                    id="option_radio_d" @checked($question->correct_option == 'option_d')>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('teacher.question.index', $question->quiz_id) }}"
