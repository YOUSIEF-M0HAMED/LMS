                    ...
                    <div class="first-div rounded-top text-white d-flex flex-row">
                        <div class="ms-4 mt-5 d-flex flex-column">
                            @if (Auth::guard('teacher')->user()->image != null)
                                <form id="photoForm-1"
                                    action="{{ route('teacher.change_profile_photo', Auth::guard('teacher')->user()->id) }}"
                                    ...
                                    <label for="profile-image-1" style="cursor: pointer;">
                                        <div class="profile-image mt-4 mb-2">
                                            <img class="img-fluid img-thumbnail mt-4 mb-2 w-100"
                                                src="{{ asset(Auth::guard('teacher')->user()->image) }}" alt="">
                                        </div>
                                    </label>
                            ...
                            @endif
                            <a href="{{ route('teacher.confirm_password', Auth::guard('teacher')->user()->id) }}"
                        ...
                        <div class="ms-3 main-info-holder">
                            <h5>Welcome Back,</h5>
                            <p>{{ Auth::guard('teacher')->user()->fname }}</p>
                        </div>
                    </div>
