        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('teacher.change_password.submit') }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="old_password" type="password"
                                        ...
                                        autocomplete="new-password" value="{{ old('old_password') }}" autofocus>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ route('teacher.profile') }}" class="btn btn-warning ms-4">
                                        {{ __('Cancel') }}
                                    </a>
                                </div>
                            </div>
