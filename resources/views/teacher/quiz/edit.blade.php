                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                        ...
                                        value="{{ $quiz->title }}" autocomplete="title" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="from_time" type="datetime-local"
                                        ...
                                        value="{{ $quiz->from_time }}" autocomplete="from_time" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="to_time" type="datetime-local"
                                        ...
                                        value="{{ $quiz->to_time }}" autocomplete="to_time" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="duration" type="number"
                                        ...
                                        value="{{ $quiz->duration }}" autocomplete="duration"
