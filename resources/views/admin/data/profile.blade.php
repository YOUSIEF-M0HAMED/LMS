                    ...
                    <div class="first-div rounded-top text-white d-flex flex-row">
                        <div class="ms-4 mt-5 d-flex flex-column">
                            @if (Auth::guard('admin')->user()->image != null)
                                <form id="photoForm-1"
                                    action="{{ route('admin.change_profile_photo', Auth::guard('admin')->user()->id) }}"
                            ...
                            @endif
                            <a href="{{ route('admin.confirm_password', Auth::guard('admin')->user()->id) }}"
                        ...
                        <div class="ms-3 main-info-holder">
                            <h5>Welcome Back,</h5>
                            <p>{{ Auth::guard('admin')->user()->fname }}</p>
                        </div>
                    </div>
                            ...
                            <div class="info-holder p-4">
                                ...
                                <div class="additional-info d-none">
                                    <div class="me-2 p-2 w-100 mb-2">
                                        ...
                                        <p class="font-italic mb-1 d-inline-block fw-bold">
                                            {{ Auth::guard('admin')->user()->admin_id }}</p>
                                    </div>
                                    <div class="me-2 p-2 w-100 mb-2">
