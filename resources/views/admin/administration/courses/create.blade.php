                        ...
                        <form method="POST" action="{{ route('admin.course.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="teacher_id"
                                    class="col-md-4 col-form-label text-md-end">Teacher (OPTIONAL)</label>

                                    <div class="col-md-6">
                                      <div class="dropdown">
                                          <!-- Dropdown button -->
                                          <select id="teacher_id" name="teacher_id" class="form-select @error('teacher_id') is-invalid @enderror" aria-label="Default select example">
                                ...
                                <label for="course_code"
                                  ...
                                  <div class="col-md-6">
                                      <input id="course_code" type="text"
                                          ...
                                          value="{{ old('course_code') }}" autocomplete="course_code" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="specification" type="text" class="form-control h-100 @error('specification') is-invalid @enderror"
                                        name="specification" autocomplete="specification" autofocus>{{ old('specification') }}</textarea>
