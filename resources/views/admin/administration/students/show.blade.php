                    ...
                    <div class="first-div rounded-top text-white d-flex flex-row">
                        <div class="ms-4 mt-5 d-flex flex-column">
                            @if ($student->image != null)
                                <form id="photoForm-1"
                                    action="{{ route('admin.students.change_profile_photo', $student->id) }}" method="post"
                            ...
                            <div class="info-holder p-4">
                                <div class="important-info">
                                    ...
                                    <div class="me-2 p-2 w-100 mb-2">
                                        ...
                                        <p class="font-italic mb-1 d-inline-block fw-bold">{{ $student->email }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="additional-info d-none">
                                    <div class="me-2 p-2 w-100 mb-2">
                                        ...
                                        <p class="font-italic mb-1 d-inline-block fw-bold">{{ $student->student_id }}</p>
                                    </div>
                                    <div class="me-2 p-2 w-100 mb-2">
                                        <p class="first font-italic mb-1 d-inline-block">Username:</p>
                                        <p class="font-italic mb-1 d-inline-block fw-bold">{{ $student->username }}</p>
                                    </div>
                                    <div class="me-2 p-2 w-100 mb-2">
                                        <p class="first font-italic mb-1 d-inline-block">Phone:</p>
                                        <p class="font-italic mb-1 d-inline-block fw-bold">{{ $student->phone }}</p>
                                    </div>
                                </div>
                            </div>
