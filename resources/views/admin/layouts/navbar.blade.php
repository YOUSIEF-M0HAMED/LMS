        ...
        <div class="user-settings d-flex">
            ...
            <li id="color-modes" class="li-user-setting">
                ...
                <ul class="shadow-sm">
                    ...
                    <li>
                        <a href="#">
                            <i class="fa-solid fa-desktop mx-2 fs-6"></i>
                            System
                        </a>
                    </li>
                </ul>
            ...
            <li id="user-info" class="li-user-setting">
                @if (Auth::guard('admin')->user()->image != null)
                    <img class="profile-img" src="{{ asset(Auth::guard('admin')->user()->image) }}" alt="">
                @else
                ...
                <ul class="shadow-sm">
                    <li>
                        <a href="{{ route('admin.profile') }}" class="d-flex">
                            @if (Auth::guard('admin')->user()->image != null)
                                <img class="profile-img" src="{{ asset(Auth::guard('admin')->user()->image) }}"
                                    alt="">
                            @else
                                <i class='fa-solid fa-user profile-icon'></i>
                            @endif
                            <p class="user mb-0">{{ Auth::guard('admin')->user()->fname }}
                                <span class="user-role d-block">Admin</span>
                            </p>
                        </a>
                    </li>
                    <li>
